...
2. Una vez ejecutado, se solicita al usuario 2 cosas:
   ...
   2.2 Se incluye la opción de añadir ruido gaussiano blanco a los datos de entrada, con el objetivo de simular condiciones más realistas y evaluar la robustez del modelo frente a perturbaciones estocásticas.
